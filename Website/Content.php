     ...
     <div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
					<li>
						<img src="img/lapb.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
								Laptop <span class="primary">MSI <strong>Gaming</strong></span>
							</h2>
							<h4 class="caption subtitle">Window 11 GTX1650</h4>
							<a class="caption button-radius" href="#"><span class="icon"></span>Shop now</a>
						</div>
					</li>
					<li><img src="img/pc0.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
								PC Dell<span class="primary"> Core i9<strong> RTX3090</strong></span>
							</h2>
							<h4 class="caption subtitle">Home & Student/WiFi 802.11ax</h4>
							<a class="caption button-radius" href="#"><span class="icon"></span>Shop now</a>
						</div>
					</li>
					<li><img src="img/tn0.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
								Headphone <span class="primary">Zidli <strong>ZH27</strong></span>
							</h2>
							<h4 class="caption subtitle">Select Item</h4>
							<a class="caption button-radius" href="#"><span class="icon"></span>Shop now</a>
						</div>
					</li>
					<li><img src="img/c0.png" alt="Slide">
						<div class="caption-group">
						  <h2 class="caption title">
								Mouse Gaming <span class="primary">Logitech <strong>G </strong></span>
							</h2>
							<h4 class="caption subtitle">Black&White</h4>
							<a class="caption button-radius" href="#"><span class="icon"></span>Shop now</a>
						</div>
					</li>
				</ul>
